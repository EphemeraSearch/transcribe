<?
include($_SERVER['DOCUMENT_ROOT'] . "/assets/common_v1.php"); 
?>
                ...
                <div class="content-mid">
                    ...
                    <div class="forms-box">
                        ...
                        <form id="full-postcard-form" class="full-postcard-form display-form form-item">
                            ...
                            <input type="text" name="card-form" id="card-from" class="needs-toggling toggled"><br>
...
<?
include($_SERVER['DOCUMENT_ROOT'] . "/assets/footer_v1.php"); 
?>